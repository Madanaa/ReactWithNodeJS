                ...
                <form>
                    <div className="row">
                        <div className="form-group col-md-6">
                            <label htmlFor="exampleInputEmail1"> Your First Name</label>
                        ...
                        <div className="form-group col-md-6">
                            <label htmlFor="exampleInputPassword1">Your Last Name</label>
                    ...
                    <button type="button" onClick= {(e) => createUser()} className="btn btn-danger">Create Your Account</button>
                </form>
                </div>
            </div>
        </div>
